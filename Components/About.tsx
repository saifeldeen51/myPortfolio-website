      ...
      <div className='grid grid-cols-1 md:grid-cols-2 w-[80%] mx-auto gap-[3rem] items-center'>
        <div>
            ...
            <div className='mb-[3rem] flex items-center md:space-x-10'>
                ...
                <p className='text-[19px] text-slate-300 w-[80%]'> Graphic and Motion Designer with a talent for thinking outside the box and coming up with innovative ideas and
 designs with 4 years of experience in Adobe Creative Suit.</p>
            </div>
        ...
        <div className='absolute w-[95%] h-[85%] z-[10] bg-[#55e6a5] top-[0.5rem] right-[-2rem]'></div>
        </div>
      </div>
    </div>
  );
