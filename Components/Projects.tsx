  ...
  return (
    <div className='bg-[#02050a] pt-[4rem] md:pt-[8rem] pb-[1rem]' id='projects'>
      ...
      <div className='pt-[3rem] justify-center grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[3rem]'>
        <div>
        <div className='transform cursor-pointer hover:-translate-y-6 transition-all duration-200 relative w-[100%] h-[200px] md:h-[300px]' onClick={() => handleVideoClick(0)}>
          {showVideos[0] ?(
          <ReactPlayer url='/videos/geometric-shapes.mp4' controls={true} width='100%' height='100%' config={{
            ...
            <div className="absolute inset-0 flex justify-center items-center">
                  <PlayIcon className="h-16 w-16 text-black opacity-90 hover:opacity-100 hover:text-yellow-400 transition-opacity" />
            </div>
            </>
          )}
          </div>
        ...
        <div>
        <div className='transform cursor-pointer hover:-translate-y-6 transition-all duration-200 relative w-[100%] h-[200px] md:h-[300px]' onClick={() => handleVideoClick(1)}>
          {showVideos[1] ?(
        ...
        <div>
        <div className='transform cursor-pointer hover:-translate-y-6 transition-all duration-200 relative w-[100%] h-[200px] md:h-[300px]' onClick={() => handleVideoClick(2)}>
          {showVideos[2] ?(
          <ReactPlayer url='/videos/geometric-shapes.mp4' controls={true} width='100%' height='100%' config={{
            file: {
              attributes: {
